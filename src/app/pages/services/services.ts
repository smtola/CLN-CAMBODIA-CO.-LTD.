...
export class Services implements OnInit {
  ...
  services = [
    ...
    {key: 'land', title:'Cross Border (Land Transport)', description:' CLN Logistics has a full capability in handling shipment for customer from A to Z with the full correspondence of back up, feedback and responsibility. We have done successful for customersʼ shipments with difference commodities and in a difference time with professing un-stuff as below pictures attached herewith.', image:'assets/image/cross.png'},
    ...
    {key: 'iec', title:'International Express Courier', description:'CLN Logistics has a full capability in handling shipment for customer from A to Z with the full correspondence of back up, feedback and responsibility. We have done successful for customersʼ shipments with difference commodities and in a difference time with professing un-stuff as below pictures attached herewith.', image:'assets/image/international express.jpg'},
